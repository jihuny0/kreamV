...
<%
	  List<ProdVO> menRecommendList = (List<ProdVO>)request.getAttribute("menRecommendList"); 
%>
	

<br><br><h2 class="title"><b>남성 추천 컬렉션</b></h2>
<h5 class="title2">KreamV에서 추천하는 인기 상품</h5><br>

<div  class="productList">

<%
for(ProdVO prodVo : menRecommendList){ 
%>
